...
function welcomeScreen(){
	...
	ctx.fillText("FORKED FROM PACMAN BY: ZI WANG, BINGYING XIA", CANVAS_WIDTH/2 , CANVAS_HEIGHT/20*19);
  ctx.fillText("AI WRITTEN BY: VIPUL NATARAJ", CANVAS_WIDTH/2, CANVAS_HEIGHT/20*18);
